...
<template>
  <div>
    ...
    <addServiceGroup
      :dialog-visible.sync="dialogVisible_add"
      :dialogData="dialogData_add"
      @dialogVisible="closeFrom"
    ></addServiceGroup>
    <relevanceUser
      :dialog-visible.sync="dialogVisible_user"
      :dialogData="dialogData_user"
...
import addServiceGroup from './components/addServiceGroup.vue'
import relevanceUser from './components/relevanceUser.vue'
...
export default {
  ...
  methods: {
    ...
    addServiceGroup() {
      function obj() {}
      this.dialogData_add = new obj()
      this.dialogVisible_add = true
      this.dialogData_add.edit = false
    },
    //关闭弹窗
    closeFrom(val, num) {
      this.dialogVisible_add = val
      if (num) {
        this.getList()
      }
    },
    // 编辑
    edit(row) {
      this.dialogData_add = row
      this.dialogData_add.edit = true
      this.dialogVisible_add = true
    },
    //打开关联用户弹窗
    relevance(row) {
